...
class TestTranscend:
    client = Transcend(base_url=base_url, api_key=api_key, bearer_token=bearer_token, _strict_response_validation=True)
...
class TestAsyncTranscend:
    ...
    def test_base_url_trailing_slash(self, client: AsyncTranscend) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncTranscend) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncTranscend) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
