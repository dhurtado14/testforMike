...
from transcend import Transcend, AsyncTranscend, DefaultAioHttpClient
from transcend._utils import is_dict
...
logging.getLogger("transcend").setLevel(logging.DEBUG)
...
def client(request: FixtureRequest) -> Iterator[Transcend]:
...
@pytest.fixture(scope="session")
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncTranscend]:
